...
export default function ResearchManagementView() {
  ...
  async function onDelete(id) {
    const ok = window.confirm("Delete this research paper?");
    if (!ok) return;
    try {
    ...
    <div className="min-h-screen bg-[#10131a] text-[#e1e2eb] font-sans relative overflow-hidden">
      ...
      <div className="mx-auto hidden min-h-screen grid-cols-[280px_1fr] lg:grid relative z-10">
        ...
        <section className="min-w-0 flex flex-col">
          <AdminHeader title="Research Papers" />
          ...
          <main className="px-6 py-8 flex-1">
            ...
            <section className="border border-[#3b494b] bg-[#161b22]/70 backdrop-blur-xl">
              <div className="border-b border-[#3b494b] px-6 py-4">
                <h2 className="text-lg font-bold text-[#e1e2eb] uppercase tracking-wider">Article List</h2>
              </div>
      ...
      <div className="mx-auto min-h-screen w-full lg:hidden relative z-10 flex flex-col">
        ...
        <main className="flex-1 px-4 pb-28 pt-6">
          <div className="mb-6 flex flex-col gap-4">
            ...
            <Link to="/admin/research/new" className="flex items-center justify-center gap-2 border border-[#00dbe9] bg-[#00dbe9]/10 text-[#00dbe9] px-4 py-4 text-[11px] font-bold uppercase tracking-widest transition-all">
              <Plus size={20} /> Publish_New_Paper
            </Link>
          </div>
